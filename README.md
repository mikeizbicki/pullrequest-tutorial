...
Follow [this seven step procedure](https://jarv.is/notes/how-to-pull-request-fork-github) to submit a pull request to fix the typo.
Notice that this tutorial was written for working programmers and not for this class.
By completing the tutorial, you are practicing both learning how to use git/github
and also how to learn material for yourself.
